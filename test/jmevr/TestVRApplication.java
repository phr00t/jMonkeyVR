...
public class TestVRApplication extends VRApplication {
    ...
    public static TestVRApplication myApp;
    
    boolean moveForward, moveBackwards, rotateLeft, rotateRight;
    Node scene;
    public static void main(String[] args) {
        myApp = new TestVRApplication();
        myApp.preconfigureVRApp(false, false, false, true);
        myApp.start();
        ...
        ActionListener acl = new ActionListener() {
            ...
            public void onAction(String name, boolean keyPressed, float tpf) {
                if(name.equals("incShift") && keyPressed){
                    VRApplication.getVRAppState().getGuiNode().adjustGuiDistance(-0.1f);
